            ...
            if ( typeof(res) != 'undefined' ) {
                $(res.hits.hits).each(function() {
                    rowData.push([
                        ...
                        '<div class="cell_contents" title="' + this._source.description + '" style="width: 288px;">' + /*this._source.description*/ '<< not yet available >>' + '</div>',
        ...
        $("#dist_details_results_table_container").fadeOut(function() {
            ...
            if ( typeof(res) != 'undefined' ) {
                $(res.hits.hits).each(function() {
                    rowData.push([
                        '<div class="cell_contents" title="' + this._source.name + '" style="width: 320px;">' + this._source.name + '</div>',
                        '<div class="cell_contents" title="' + this._source.description + '" style="width: 288px;">' + '<< not yet available >>' + '</div>',
